...
?>
      ...
      <main class="app-main">
        ...
        <div class="app-content-header">
          ...
          <div class="container-fluid">
            <!--begin::Row-->
            <div class="row">
              <div class="col-sm-6"><h3 class="mb-0">Gestionar Usuarios</h3></div>
              <div class="col-sm-6">
        ...
        <div class="app-content">
          ...
          <div class="container-fluid">
            <div class="row">
              <div class="col-sm-6">
                  <button class="agregarbtn btn btn-success mb-3" data-bs-toggle="modal" data-bs-target="#modalAgregarUsuarios">Agregar Usuario</button>
              </div>
            </div>
            <div class="row">
                <table class="table-akatsuki"  id="tablaUsuarios">
                    <thead class="table">
                    <tr>
                        <th>Acciones</th>
                        <th>ID</th>
    ...
    <?php 
    include_once '../modals/usuarios.php';
