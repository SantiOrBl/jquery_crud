...
?>
<script type="text/javascript" src="../assets/js/scripts/publicaciones.js"></script>
...
?>
      ...
      <main class="app-main">
        ...
        <div class="app-content-header">
          ...
          <div class="container-fluid">
            <!--begin::Row-->
            <div class="row">
              <div class="col-sm-6"><h3 class="mb-0">Gestionar Publicaciones</h3></div>
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-end">
                  <li class="breadcrumb-item"><a href="inicio.php">Inicio</a></li>
                  <li class="breadcrumb-item active" aria-current="page">Gestionar Publicaciones</li>
                </ol>
              </div>
            </div>
            <!--end::Row-->
        ...
        <div class="app-content">
          ...
          <div class="container-fluid">
            <div class="row">
              <div class="col-sm-6">
                  <button class="agregarbtn btn btn-success mb-3" data-bs-toggle="modal" data-bs-target="#modalAgregarPublicaciones">Agregar Publicacion</button>
              </div>
            </div>
            <div class="row">
                <table class="table-akatsuki" id="tablaPublicaciones">
                    <thead class="table">
                    <tr>
                        <th>Acciones</th>
                        <th>ID</th>
                        ...
                        <th>Titulo</th>
                        <th>Contenido</th>
                        <th>Fecha de Publicacion/Modificacion</th>
                    </tr>
                    </thead>
                    <tbody></tbody>
                </table>
    ...
    <?php 
    include_once '../modals/publicaciones.php';
